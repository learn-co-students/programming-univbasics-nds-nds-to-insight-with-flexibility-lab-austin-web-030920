...
def movies_with_director_key(name, movies_collection)
  ...
  # director_movies = movie_with_director_name()
  result = []
  i = 0
...
def movies_with_directors_set(source)
  ...
  while director_index < source.count do
    ...
    movie_index = 0
    while movie_index < director[:movies].count do
      movie = director[:movies][movie_index]
      # set director name
      movie[:director_name] = director[:name]

      movie_index += 1
    end
    # append director's modified movies array to the result array
